...
- RVI Android SIG 工作更新：
  ...
  - Chromium for Android apk 构建初始支持：目前决定升级到新的 tag `109.0.5414.87` 开发。RVI Android SIG 新建了 chrome for riscv64 的仓库 <https://github.com/riscv-android-src/chromium>。我们先在该仓库上基于 aosp 12 开发，成功后在提交到 Chromium 的 Google 官方仓库。
