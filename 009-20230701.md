...
- [软件所 Box64 RISC-V 移植工作取得重要成果](https://mp.weixin.qq.com/s/1Sh1VLHyEkialf-VgkbCew)。通过将 Box64 移植到 RISC-V 环境中，使得 x86_64 程序兼容到 RISC-V 系统，更多的软件得以在 RISC-V 系统中顺利运行。同时为了进一步改善性能，将 Box64 与 DynaRec 整合在 RV64 平台上，实现了比只使用解释器快 5 至 10 倍的速度提升。

- Eulaceura 版本23H1，适用于 矽速科技 LicheePi 4A 的映像现已公布。可访问 https://mirror.iscas.ac.cn/openeuler-sig-riscv/eulaceura/ 取得
  映像存放于 image/23H1/ 资料夹内，选取尾缀为 Desktop Full 的版本安装使用。

- [祝贺！邱吉博士经 RISC-V 国际基金会正式确认，成为 RISC-V 大使](https://mp.weixin.qq.com/s/okhNPbTySDrKPqat5oAMXQ)

- [SiFive RISC-V中国技术论坛](https://mp.weixin.qq.com/s/2DgflUIZkUCiRURF1quhlw) 于6月26日上海站、6月28日北京站、6月30日深圳站三城巡讲。吴伟老师作为上海站专题讨论的嘉宾出席论坛。
...
- [第三届RISC-V中国峰会演讲征集已经开始，7月5日截止。](https://mp.weixin.qq.com/s/5_Nyb0qe_U7tzeyfQyQcRg) 欢迎大家抓紧时间报名参加。
...
- [Test python and pytorch for openeuler on visionfive2 ](https://gitee.com/samuel_yuan/riscv-openeuler-visionfive/blob/master/chapter3-Test-openeuler-software-on-visionFive/Test-python-and-pytorch-for-openeuler-on-visionfive2.md) @samuel_yuan

- [Build EDK2 UEFI firmware to boot openEuler on QEMU（Part A） ](https://gitee.com/samuel_yuan/play-with-openeuler-on-riscv-platform/blob/master/chapter1/Build-edk2-uefi-firmware-to-boot-openeuler-on-qemu-part-a.md) @samuel_yuan
