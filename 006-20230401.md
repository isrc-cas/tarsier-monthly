...
- 2、Fedora 37 Image for [Sophgo SG2042](http://openkoji.iscas.ac.cn/kojifiles/work/tasks/9279/839279/fedora-disk-developer-xfce_sophgo_sg2042-f37-20230226-105950.n.0-sda.raw.xz)
- 3、Fedora 37 Image for [T-Head TH1520](http://openkoji.iscas.ac.cn/kojifiles/work/tasks/884/880884/fedora-disk-developer-xfce_thead_th1520-f37-20230329-031102.n.0-sda.raw.xz)
- 4、ROS/ROS2的软件编译和安装，测试已经完成，相关依赖问题基本解决。

### 赵佳盛

- 1、跟踪ROCKS的编译进度：rocks 软件包跟踪：[文档](https://github.com/fedora-riscv/rocks_track_doc)， 对所有可能的upstream包和导师进行确认。
- 2、学习并翻译 [Fedora Release Engineering 文档](https://github.com/fedora-riscv/releng.git)
- 3、管理  Openkoji 编译 tags, 管理[Fedora 38 tags 组](https://openkoji.iscas.ac.cn/koji/tags)

### ImBearChild

- 1、对ROS2依赖Mimick进行移植编译和测试。{任务完成}
[Mimick](https://github.com/fedora-riscv/Mimick/tree/riscv64)
- 2、ROS2编译: 所有依赖已经补齐，完成了从编译、测试，随后到文档的过程{任务完成}
[ROS2编译教程](https://github.com/fedora-riscv/Fedora_riscv_devel_docs/blob/main/fedora-riscv-ros2-complie.md)
- 3、ROS2成果及测试log: 测试软件包中提供的所有demo和测试程序并保留[所有结果文件](https://openkoji.iscas.ac.cn/pub/dl/riscv/ROS2/ros2_riscv64_test_log.tar.gz)

### Milkice
- 1、对ROS1依赖sbcl进行移植编译和测试。{任务完成}：[编译测试文档](https://github.com/fedora-riscv/sbcl-build-docs)
- 2、ROS1编译：对 ROS1编译进行研究，搜集了针对Fedora37的所需依赖，补齐所有依赖，并完成了从编译和文档的过程{任务完成}。[ROS1编译教程](https://github.com/fedora-riscv/ros1-build-docs/blob/main/README.md)，正在找ROS1的测试方法和demo.
...
- https://github.com/RT-Thread/rt-thread/pull/7122
